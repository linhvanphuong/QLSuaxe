        ...
        success: function (response) {
            if (response.result) {
                ...
                var trAppend2 = '<tr ><td style="width:10%;text-align:center;">' + '<a class="AccXoa" href="javascript:;"><i class="fas fa-trash-alt"></i></a>' + '</td><td style="width:30%">' + option2.name + '</td>' +
                    '<td class="AssId" style="width:10%">' + option2.id + '</td>' + '<td class="AssPrice" style="width:10%">' + '<input class="AssImportPrice"  onblur="changeThanhTien(' + option2.id +')"  type="number" min="0" step="1" value="0" id="row2SL_' + option2.id + '" >' + '</td>' +
                    '<td class="AssQuantity" style="width:10%">' + '<input type="number" data-max="' + option2.quantity + '" onblur="changeThanhTien(' + option2.id+')" min="1" step="1"  value="1" id="row2number_' + option2.id + '">' + '</td>' + '<td style="width: 10% ">' + option2.unit + '</td>' +
                    '<td style="width:20%"><p class="TongTien" id="TT_' + option2.id + '"> 0 VNĐ</td>';
