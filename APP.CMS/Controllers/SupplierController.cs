...
namespace APP.CMS.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public async Task<IActionResult> Update(long id)
        {
            try
            {
                var data = await _supplierManager.Find_By_Id(id);
        ...
        public async Task<IActionResult> Create_Or_Update(Supplier inputModel)
        {
            try
            {
                ...
                {
                    await _supplierManager.Update(inputModel);
