...
namespace APP.CMS.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        public MenuController(IMenuManager menuManager, IHttpContextAccessor httpContextAccessor)
        {
        ...
        [CustomAuthen]
        [HttpGet("get-list")]
        public async Task<IActionResult> Get_List(string name, byte status,long parentId)
        {
            try
            {
                var data = await _menuManager.Get_List(name, status, parentId);
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewData["listParentMenu"] = await _menuManager.Get_List_Parent_Menu();
            return View();
        }
    }
}
