...
{
    [Route("quay-sua")]
    public class MotorLiftsController : Controller
    {
        private readonly IMotorLiftsManager _motorLiftsManager;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private ISession _session => _httpContextAccessor.HttpContext.Session;
        public MotorLiftsController(IMotorLiftsManager motorLiftsManager, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Get_List(string name, byte status)
        {
            try
            {
                var data = await _motorLiftsManager.Get_List(name, status);
        ...
        public async Task<IActionResult> Update(long id)
        {
            try
            {
                var data = await _motorLiftsManager.Find_By_Id(id);
        ...
        public async Task<IActionResult> Delete(long id)
        {
            try
            {
                await _motorLiftsManager.Delete(id);
