...
namespace APP.CMS.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Update(long id)
        {
            try
            {
                var data = await _customersManager.Find_By_Id(id);
        ...
        public async Task<IActionResult> Create_Or_Update(Customers inputModel)
        {
            try
            {
                ...
                {
                    await _customersManager.Update(inputModel);
